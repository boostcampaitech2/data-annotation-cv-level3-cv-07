...
add_data_dir = os.environ.get('SM_CHANNEL_TRAIN', '../../input/data/dataset_revised')  # json 들어있는 폴더
wrong_labeled = list(pd.read_csv('./etc/revised_wrong0~500.csv')['id'])
...
with open(osp.join(add_data_dir,'ufo', 'train_deleted.json'), 'w') as f:
